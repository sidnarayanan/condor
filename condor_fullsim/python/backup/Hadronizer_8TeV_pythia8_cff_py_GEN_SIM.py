...
# with command line options: Configuration/GenProductions/python/EightTeV/Hadronizer_8TeV_pythia8_cff.py --step GEN,SIM --beamspot Realistic8TeVCollision --conditions START53_V7C::All --pileup NoPileUp --datamix NODATAMIXER --eventcontent RAWSIM --datatier GEN-SIM -n 10 --filein file:dummyfile --customise Configuration/GenProductions/randomizeSeeds.randomizeSeeds --fileout file:GEN_SIM_file.root --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProductions/python/EightTeV/Hadronizer_8TeV_pythia8_cff.py nevts:10'),
