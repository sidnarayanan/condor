...
# with command line options: MinBias_8TeV_cfi --conditions auto:startup -s GEN,SIM --datatier GEN-SIM -n 300 --eventcontent RAWSIM --fileout pileup.root --customise Configuration/GenProductions/randomizeSeeds.randomizeSeeds
