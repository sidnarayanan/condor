...
#    fileNames = cms.untracked.vstring('file:/home/snarayan/scratch/2l_sample_manual/Events/unweighted_events.lhe')
    fileNames = cms.untracked.vstring('file:/home/snarayan/scratch/mg5_test/decay_by_pythia/Events/run_02/unweighted_events.lhe')
)
...
#    ),
    ...
    PythiaParameters = cms.PSet(
      ...
      'MDME(183,1)=1      !Z decay into nu_e nu_e~',
      'MDME(184,1)=1      !Z decay into mu+ mu-',
      'MDME(185,1)=1      !Z decay into nu_mu nu_mu~',
      'MDME(186,1)=1      !Z decay into tau+ tau-',
      'MDME(187,1)=1      !Z decay into nu_tau nu_tau~',
      'MDME(2337,1)=1     !~chi_20 decay into ~chi_10 Z0',
      'MDME(2597,1)=1     !~chi_1+ decay into ~chi_10 W+',
