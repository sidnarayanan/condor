...
# with command line options: STEP2 --step RAW2DIGI,L1Reco,RECO --conditions START53_V19::All --eventcontent AODSIM --datatier AODSIM -n -1 --filein file:GEN-Fragment_DIGI_L1_DIGI2RAW_HLT_PU.root --customise Configuration/GenProductions/randomizeSeeds.randomizeSeeds --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:GEN-Fragment_DIGI_L1_DIGI2RAW_HLT_PU.root')
)
