...
echo "root -b -l -q runFlatBoostedV.C+\(\"${indir}/boostedv_s12-pj1800-v7a_noskim_0000_ntuple_000.root\"\)"
root -b -l -q runFlatBoostedV.C+\("\"${indir}/boostedv_s12-pj1800-v7a_noskim_0000_ntuple_000.root\""\)
